...
// Code is generated on: 8/8/2018 8:01:01 p.m.
//
...
namespace HjaContext
{
    ...
    public partial class HjaDataContext : Devart.Data.Linq.DataContext
    {
        ...
        public Devart.Data.Linq.Table<Paciente> Pacientes
        {
            get
            {
        ...
        public Devart.Data.Linq.Table<Expediente> Expedientes
        {
            get
            {
...
namespace HjaContext
{
    ...
    public partial class Receta : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private System.Nullable<int> _EncargadoId;
        ...
        partial void OnEncargadoIdChanging(System.Nullable<int> value);
        partial void OnEncargadoIdChanged();
        partial void OnPamIdChanging(int value);
        ...
        /// </summary>
        [Column(Name = @"encargado_id", Storage = "_EncargadoId", DbType = "INT4", UpdateCheck = UpdateCheck.Never)]
        public System.Nullable<int> EncargadoId
        {
            get
            {
        ...
        /// </summary>
        [Column(Name = @"pam_id", Storage = "_PamId", CanBeNull = false, DbType = "INT4 NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public int PamId
        {
            get
            {
        ...
        public Persona Persona_EncargadoId
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._Persona_EncargadoId.HasLoadedOrAssignedValue == false))
                {
                    ...
                    {
                        this._EncargadoId = default(System.Nullable<int>);
                    }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Receta_RecetaDetalle", Storage="_RecetaDetalles", ThisKey="Id", OtherKey="RecetaId", DeleteRule="NO ACTION")]
    ...
    public partial class RecetaDetalle : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnIdChanging(int value);
        partial void OnIdChanged();
        partial void OnRecetaIdChanging(int value);
        partial void OnRecetaIdChanged();
        partial void OnMedicamentoIdChanging(int value);
        ...
        /// </summary>
        [Column(Name = @"receta_id", Storage = "_RecetaId", CanBeNull = false, DbType = "INT4 NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public int RecetaId
        {
            get
            {
        ...
        /// </summary>
        [Column(Name = @"medicamento_id", Storage = "_MedicamentoId", CanBeNull = false, DbType = "INT4 NOT NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Name = @"via_id", Storage = "_ViaId", CanBeNull = false, DbType = "INT4 NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public int ViaId
        {
            get
            {
        ...
        public Medicamento Medicamento
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._Medicamento.HasLoadedOrAssignedValue == false))
                {
                    ...
                    {
                        this._MedicamentoId = default(int);
                    }
    ...
    public partial class Medicamento : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"peso", Storage = "_Peso", DbType = "NUMERIC(10)", UpdateCheck = UpdateCheck.Never)]
        ...
        /// There are no comments for RecetaDetalles in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Medicamento_RecetaDetalle", Storage="_RecetaDetalles", ThisKey="Id", OtherKey="MedicamentoId", DeleteRule="NO ACTION")]
        public EntitySet<RecetaDetalle> RecetaDetalles
        {
            get
            {
    ...
    public partial class Via : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for RecetaDetalles in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Via_RecetaDetalle", Storage="_RecetaDetalles", ThisKey="Id", OtherKey="ViaId", DeleteRule="NO ACTION")]
        public EntitySet<RecetaDetalle> RecetaDetalles
        {
            get
            {
    ...
    public partial class Persona : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Persona_Receta", Storage="_Recetas_EncargadoId", ThisKey="Id", OtherKey="EncargadoId", DeleteRule="NO ACTION")]
    ...
    public partial class PersonaRol : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"persona_id", Storage = "_PersonaId", CanBeNull = false, DbType = "INT4 NOT NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Name = @"rol_id", Storage = "_RolId", CanBeNull = false, DbType = "INT4 NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public int RolId
        {
            get
            {
    ...
    /// <summary>
    /// There are no comments for HjaContext.Paciente in the schema.
    /// </summary>
    [Table(Name = @"hja.paciente")]
    public partial class Paciente : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for Cedula in the schema.
        /// </summary>
        [Column(Name = @"cedula", Storage = "_Cedula", DbType = "CHAR(10)", UpdateCheck = UpdateCheck.Never)]
        public string Cedula
        {
            get
            {
        ...
        /// There are no comments for Nombre in the schema.
        /// </summary>
        [Column(Name = @"nombre", Storage = "_Nombre", DbType = "CHAR(50)", UpdateCheck = UpdateCheck.Never)]
        public string Nombre
        {
            get
            {
        ...
        /// </summary>
        [Column(Name = @"apellido1", Storage = "_Apellido1", DbType = "CHAR(50)", UpdateCheck = UpdateCheck.Never)]
        public string Apellido1
        {
            ...
            set
            {
                if (this._Apellido1 != value)
                {
                    ...
                    this.SendPropertyChanging("Apellido1");
        ...
        /// </summary>
        [Column(Name = @"apellido2", Storage = "_Apellido2", DbType = "CHAR(50)", UpdateCheck = UpdateCheck.Never)]
        public string Apellido2
        {
            ...
            set
            {
                if (this._Apellido2 != value)
                {
                    ...
                    this.SendPropertyChanging("Apellido2");
        ...
        /// </summary>
        [Column(Name = @"""fechaNacimiento""", Storage = "_FechaNacimiento", DbType = "DATE", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Name = @"genero", Storage = "_Genero", DbType = "CHAR(1)", UpdateCheck = UpdateCheck.Never)]
        public string Genero
        {
            ...
            set
            {
                if (this._Genero != value)
                {
                    ...
                    this.SendPropertyChanging("Genero");
                    this._Genero = value;
        ...
        /// </summary>
        [Column(Name = @"altura", Storage = "_Altura", DbType = "NUMERIC(10)", UpdateCheck = UpdateCheck.Never)]
    ...
    /// <summary>
    /// There are no comments for HjaContext.Expediente in the schema.
    /// </summary>
    [Table(Name = @"hja.expediente")]
    public partial class Expediente : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// There are no comments for IdPaciente in the schema.
        /// </summary>
        [Column(Name = @"""idPaciente""", Storage = "_IdPaciente", DbType = "INT4", UpdateCheck = UpdateCheck.Never)]
        public System.Nullable<int> IdPaciente
        {
            ...
            set
            {
                if (this._IdPaciente != value)
                {
                    ...
                    this.SendPropertyChanging("IdPaciente");
        ...
        /// </summary>
        [Column(Name = @"""fechaCreacion""", Storage = "_FechaCreacion", DbType = "DATE", UpdateCheck = UpdateCheck.Never)]
