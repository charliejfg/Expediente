...
=======
// Code is generated on: 11/08/2018 9:49:31
>>>>>>> master
//
...
namespace HjaContext
{
    ...
    public partial class Receta : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [Devart.Data.Linq.Mapping.SequenceGenerator(Sequence = "receta_seq")]
        public long Id
        {
            get
            {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Persona_Receta", Storage="_Persona_EncargadoId", ThisKey="EncargadoId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Persona_Receta1", Storage="_Persona_PamId", ThisKey="PamId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true)]
    ...
    public partial class RecetaDetalle : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"id", Storage = "_Id", AutoSync = AutoSync.OnInsert, CanBeNull = false, DbType = "INT8 NOT NULL", IsDbGenerated = true, IsPrimaryKey = true)]
        [Devart.Data.Linq.Mapping.SequenceGenerator(Sequence = "receta_detalle_seq")]
        public long Id
        {
            get
            {
...
=======
        [Devart.Data.Linq.Mapping.Association(Name="Receta_RecetaDetalle", Storage="_Receta", ThisKey="RecetaId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true)]
>>>>>>> master
...
=======
        [Devart.Data.Linq.Mapping.Association(Name="Medicamento_RecetaDetalle", Storage="_Medicamento", ThisKey="MedicamentoId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true)]
>>>>>>> master
...
>>>>>>> master
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Via_RecetaDetalle", Storage="_Via", ThisKey="ViaId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true)]
        public Via Via
        {
            get
            {
