...
// Code is generated on: 12/7/2018 8:54:28 p.m.
//
...
namespace HjaContext
{
    ...
    public partial class PersonaRol : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnIdChanging(long value);
        partial void OnIdChanged();
        partial void OnPersonaIdChanging(long value);
        partial void OnPersonaIdChanged();
        partial void OnRolIdChanging(long value);
        ...
        /// </summary>
        [Column(Name = @"persona_id", Storage = "_PersonaId", CanBeNull = false, DbType = "INT8 NOT NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Name = @"rol_id", Storage = "_RolId", CanBeNull = false, DbType = "INT8 NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public long RolId
        {
            get
            {
